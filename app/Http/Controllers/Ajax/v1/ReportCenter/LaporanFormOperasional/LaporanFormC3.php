...
use App\Services\Reports\LaporanFormC3 as LaporanFormC3Service;

class LaporanFormC3 extends Controller
{
  public function index(Request $request)
  {
    ...
    switch ($request->input('report_type')) {
      case 'frequency' :
        $data = LaporanFormC3Service::frequency($request);
        break;
      default :
        $data = [];
        break;
