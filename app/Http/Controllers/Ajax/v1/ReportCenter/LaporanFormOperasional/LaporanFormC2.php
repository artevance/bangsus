...
use App\Services\Reports\LaporanFormC2 as LaporanFormC2Service;

class LaporanFormC2 extends Controller
{
  public function index(Request $request)
  {
    ...
    switch ($request->input('report_type')) {
      case 'frequency' :
        $data = LaporanFormC2Service::frequency($request);
        break;
      default :
        $data = [];
        break;
    ...
    if ($request->input('export') === 'xlsx') {
      ...
      if ($request->input('report_type') == 'frequency') {
        ...
        $container = [
          ['Laporan Form C2 (Laporan Frekuensi)'],
