    ...
    responsiveContract: () => {
      ...
      obj.$.modal.tambah.on('show.bs.modal', (e) => {
        ...
        obj.rel.kelompokLaporanFoto.ajax.search()
          ...
          .done((r) => {
            console.log(r);
            $(e.currentTarget).find('form').find('[name="kelompok_laporan_foto_id"]').empty().append('<option value="null">-- Pilih Kelompok Laporan Foto --</option>');
        ...
        obj.ajax.get($(e.relatedTarget).data('id'))
          ...
          .done((r) => {
            ...
            obj.rel.kelompokLaporanFoto.ajax.search()
              ...
              .done((re) => {
                console.log(re);
                $(e.currentTarget).find('form').find('[name="kelompok_laporan_foto_id"]').empty().append('<option>-- Pilih Kelompok Laporan Foto --</option>');
