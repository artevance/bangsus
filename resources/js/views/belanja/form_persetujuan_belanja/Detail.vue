      ...
      <div class="col col-xl-12 stretch-card" v-if="!state.page.loading">
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-title">Detail Form Belanja</div>
            <form>
              <div class="row">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr v-for="(detail, i) in form.detail.data.d">
                          ...
                          <th>
                            <a :href="'/ajax/v1/belanja/gambar/' + detail.id" target="_blank">Link Foto</a>
                          </th>
                          <td>
                            {{ detail.approved ? 'Disetujui' : 'Tidak Disetujui' }}
                          </td>
                        </tr>
                      </tbody>
                    </table>
        ...
        this.$axios.get('/ajax/v1/master/barang/' + this.form.detail.data.d[i].barang_id)
          .then(res => {
            ...
            if (this.resetOtherField) {
              ...
              this.form.detail.data.d[i].harga_barang = 0
            }
