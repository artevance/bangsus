          ...
          <div class="card-body">
            ...
            <div class="row mt-5">
              <div class="col-12 col-md-6">
                <input type="text" class="form-control" placeholder="Cari sesuatu ..." v-model="query.jabatan.q" @keyup="queryData" v-if="$access('master.jabatan', 'read')">
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    queryData() {
      this.fetchMainData()
        .then(res => {
          this.data.jabatan = res.data.container
        })
        .catch(err => {})
    },
    /**
