    ...
    return {
      cards: [
        ...
        },
        {
          ...
          children: [
            { title: 'Laporan Form C1', to: 'reportCenter.laporanFormOperasional.laporanFormC1', icon: 'fas fa-file-invoice', disabled: true },
            { title: 'Laporan Form C2', to: 'reportCenter.laporanFormOperasional.laporanFormC2', icon: 'far fa-file-invoice', disabled: true },
            { title: 'Laporan Form C3', to: 'reportCenter.laporanFormOperasional.laporanFormC3', icon: 'fad fa-file-invoice', disabled: true },
            { title: 'Laporan Form C4', to: 'reportCenter.laporanFormOperasional.laporanFormC4', icon: 'fas fa-file', disabled: true },
