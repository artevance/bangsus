            ...
            <div class="col-12">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <select class="form-control" v-model="query.laporan_pembelian.cabang">
                    <option value="*">Semua Cabang</option>
                    <option v-for="(cabang, i) in data.cabang" :key="i" :value="cabang.cKetGudang">
                      {{ cabang.cKetGudang }}
                    </option>
                  </select>
...
export default {
  ...
  methods: {
     ...
     */
    fetchMainData() {
      return this.$axios.get('/ajax/v1/report_center/laporan_khusus/laporan_pembelian/by_cabang', { params: this.query.laporan_pembelian })
    },
    fetchCabang() {
      return this.$axios.get('/ajax/v1/report_center/laporan_khusus/laporan_pembelian/cabang')
    },
  }
}
</script>
