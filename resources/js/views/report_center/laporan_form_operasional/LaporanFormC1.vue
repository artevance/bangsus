            ...
            <div class="col-12">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <select class="form-control" v-model="query.laporan_form_c1.cabang_id">
                    <option value="null" v-if="$access('reportCenter.laporanFormOperasional.laporanFormC1', 'readAllBranch')">Semua Cabang</option>
                  ...
                  <select class="form-control" v-model="query.laporan_form_c1.report_type">
                  ...
                  <input type="date"
                    class="form-control"
                    v-model="query.laporan_form_c1.tanggal_awal"
                    >
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                      Tanggal Akhir
                  ...
                  <input type="date"
                    class="form-control"
                    v-model="query.laporan_form_c1.tanggal_akhir"
                    >
          ...
          <transition name="fade" mode="out-in" v-if="state.table.show">
            ...
            <div v-else>
              ...
              <div class="table-responsive mt-2">
                <table class="table table-bordered" v-if="query.laporan_form_c1.report_type == 'frequency'">
                  <thead>
                    <th>#</th>
                    <th>Cabang</th>
                    <th>Form Thawing Ayam</th>
                    <th>Form Goreng</th>
                    <th>Form Masak Nasi</th>
                    <th>Form Sambal</th>
                    <th>Form Tepung</th>
                    <th>Form Minyak</th>
                    <th>Form Margarin</th>
                  ...
                  <tbody>
                    <tr v-for="(data, i) in data.laporan_form_c1.data">
                      <td class="text-center">{{ i + 1 }}</td>
                      <td>{{ data.cabang.kode_cabang }} - {{ data.cabang.cabang }}</td>
                      <td :class="{ 'table-danger': data.form_thawing_ayam == 0 }">{{ data.form_thawing_ayam }}</td>
                      <td :class="{ 'table-danger': data.form_goreng == 0 }">{{ data.form_goreng }}</td>
                      <td :class="{ 'table-danger': data.form_masak_nasi == 0 }">{{ data.form_masak_nasi }}</td>
                      <td :class="{ 'table-danger': data.form_sambal == 0 }">{{ data.form_sambal }}</td>
                      <td :class="{ 'table-danger': data.form_tepung == 0 }">{{ data.form_tepung }}</td>
                      <td :class="{ 'table-danger': data.form_minyak == 0 }">{{ data.form_minyak }}</td>
                      <td :class="{ 'table-danger': data.form_margarin == 0 }">{{ data.form_margarin }}</td>
                      <td :class="{ 'table-danger': data.form_lpg == 0 }">{{ data.form_lpg }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
export default {
  ...
  methods: {
    ...
    prepare() {
      ...
      Promise.all([
        ...
        .then(res => {
          ...
          if (this.query.laporan_form_c1.cabang_id == null || ! this.$_.isUndefined(this.$_.findWhere(this.data.cabang, { id: this.query.laporan_form_c1.cabang_id }))) {
            this.query.laporan_form_c1.cabang_id = this.data.cabang[0].id || null
          }
    ...
    queryData(withSpinner = true) {
      ...
      this.fetchMainData()
        .then(res => {
          ...
          this.data.laporan_form_c1 = res.data.container
     ...
     */
    fetchMainData() {
      return this.$axios.get('/ajax/v1/report_center/laporan_form_operasional/laporan_form_c1', { params: this.query.laporan_form_c1 })
    },
    fetchMainDataExport(format) {
      let params = {
        cabang_id: this.query.laporan_form_c1.cabang_id,
        report_type: this.query.laporan_form_c1.report_type,
        tanggal_awal: this.query.laporan_form_c1.tanggal_awal,
        tanggal_akhir: this.query.laporan_form_c1.tanggal_akhir,
        export: format
      }
      return this.$axios.get('/ajax/v1/report_center/laporan_form_operasional/laporan_form_c1', { params: params, responseType: 'blob' })
    },
    fetchCabang() {
