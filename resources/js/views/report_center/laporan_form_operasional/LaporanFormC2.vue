            ...
            <div class="col-12">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <select class="form-control" v-model="query.laporan_form_c2.cabang_id">
                  ...
                  <select class="form-control" v-model="query.laporan_form_c2.report_type">
                  ...
                  <input type="date"
                    class="form-control"
                    v-model="query.laporan_form_c2.tanggal_awal"
                    >
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                      Tanggal Akhir
                  ...
                  <input type="date"
                    class="form-control"
                    v-model="query.laporan_form_c2.tanggal_akhir"
                    >
          ...
          <transition name="fade" mode="out-in" v-if="state.table.show">
            ...
            <div v-else>
              ...
              <div class="table-responsive mt-2">
                <table class="table table-bordered" v-if="query.laporan_form_c2.report_type == 'frequency'">
                  <thead>
                    <th>#</th>
                    <th>Cabang</th>
                    <th v-for="(quality_control, i) in data.laporan_form_c2.meta.quality_control">
                      {{ quality_control.quality_control }}
                    </th>
                    <th>Frekuensi</th>
                  </thead>
                  <tbody>
                    <tr v-for="(data, i) in data.laporan_form_c2.data">
...
export default {
  ...
  methods: {
    ...
    prepare() {
      ...
      Promise.all([
        ...
        .then(res => {
          ...
          if (this.query.laporan_form_c2.cabang_id == null || ! this.$_.isUndefined(this.$_.findWhere(this.data.cabang, { id: this.query.laporan_form_c2.cabang_id }))) {
            this.query.laporan_form_c2.cabang_id = this.data.cabang[0].id || null
          }
    ...
    queryData(withSpinner = true) {
      ...
      this.fetchMainData()
        .then(res => {
          if ( ! this.$_.isEqual(this.$route.query, this.query.laporan_form_c2) && this.$route.name === 'reportCenter.laporanFormOperasional.laporanFormC2') {
            this.$router.push({
              name: 'reportCenter.laporanFormOperasional.laporanFormC2',
              query: this.query.laporan_form_c2
            })
          }
          this.data.laporan_form_c2 = res.data.container
     ...
     */
    fetchMainData() {
      return this.$axios.get('/ajax/v1/report_center/laporan_form_operasional/laporan_form_c2', { params: this.query.laporan_form_c2 })
    },
    fetchMainDataExport(format) {
      let params = {
        cabang_id: this.query.laporan_form_c2.cabang_id,
        report_type: this.query.laporan_form_c2.report_type,
        tanggal_awal: this.query.laporan_form_c2.tanggal_awal,
        tanggal_akhir: this.query.laporan_form_c2.tanggal_akhir,
        export: format
      }
      return this.$axios.get('/ajax/v1/report_center/laporan_form_operasional/laporan_form_c2', { params: params, responseType: 'blob' })
    },
    fetchCabang() {
