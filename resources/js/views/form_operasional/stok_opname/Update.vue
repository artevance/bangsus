      ...
      <div class="col col-xl-12 stretch-card" v-if="!state.page.loading">
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-title">Ubah Stok Opname</div>
            <form>
              <div class="row">
  ...
  methods: {
    ...
    pushDetail(item) {
      this.form.update.data.d.push({
        ...
        satuan_dua: item.barang.satuan_dua,
        satuan_tiga: item.barang.satuan_tiga,  
        satuan_empat: item.barang.satuan_empat,
        satuan_lima: item.barang.satuan_lima,
    ...
    fetchMainData() {
      return this.$axios.get('/ajax/v1/form_operasional/stok_opname/' + this.$route.params.id)
    },
    fetchCabang() {
