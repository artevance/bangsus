...
export default {
  ...
  methods: {
      ...
      Promise.all([
        ...
        .then(res => {
          ...
          mainData.d.forEach((item, i) => {
            let request = this.$axios.get('/ajax/v1/form_operasional/supplier_mutation/gambar/' + item.id, { responseType: 'blob' })
    ...
    fetchMainData() {
      return this.$axios.get('/ajax/v1/form_operasional/supplier_mutation/' + this.$route.params.id)
    },
    fetchCabang() {
