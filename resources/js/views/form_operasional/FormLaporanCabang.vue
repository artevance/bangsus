<template>
  <transition name="fade" mode="out-in">
    <div class="row mt-5" v-if="$route.name == 'formOperasional.formLaporanCabang'">
            ...
            <transition name="fade" mode="out-in">
              ...
              <div v-else>
                ...
                <button class="btn btn-primary"
                  ...
                  v-if="$access('formOperasional.formLaporanCabang', 'create')">
                  Tambah
                </button>
          ...
          <div class="modal-content">
            <form @submit.prevent="create">
              <div class="modal-header">
                <h5 class="modal-title">Tambah Form Laporan Cabang</h5>
...
export default {
  ...
  methods: {
    ...
    prepare() {
      ...
      Promise.all([
        ...
        .then(res => {
          ...
          if (this.query.form_laporan_cabang.cabang_id == null) {
    ...
    queryData(withSpinner = true) {
      ...
      this.fetchMainData()
        .then(res => {
          if ( ! this.$_.isEqual(this.$route.query, this.query.form_laporan_cabang) && this.$route.name === 'formOperasional.formLaporanCabang') {
            this.$router.push({
    ...
    create() {
      ...
      this.$axios.post('/ajax/v1/form_operasional/form_laporan_cabang',
        formData,
