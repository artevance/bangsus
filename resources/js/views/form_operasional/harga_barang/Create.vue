    ...
    <div class="col col-xl-12 stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <div class="card-title">Harga Barang Baru</div>
          <form>
            <div class="row">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <thead>
                      ...
                      <th style="min-width: 200px;">Harga Baru</th>
                      <th>Keterangan</th>
                      <th>Aksi</th>
                    </thead>
                    <tbody>
...
export default {
  ...
  methods: {
    ...
    reloadSatuan(i) {
      this.$axios.get('/ajax/v1/master/barang/' + this.form.create.data.d[i].barang_id)
        .then(res => {
          ...
          this.form.create.data.d[i].harga_lama = 0
    ...
    create() {
      ...
      this.$axios.post('/ajax/v1/form_operasional/harga_barang', this.form.create.data)
        .then(res => {
