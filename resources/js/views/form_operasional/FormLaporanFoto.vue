            ...
            <div v-else>
                ...
                <div class="col-12">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <select class="form-control" v-model="query.form_laporan_foto.cabang_id" @change="queryData">
                      ...
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                          Kelompok Laporan Foto
                        </span>
                      </div>
                      <select class="form-control" v-model="query.form_laporan_foto.kelompok_laporan_foto_id" @change="queryData">
                        <option v-for="(kelompok_laporan_foto, i) in data.kelompok_laporan_foto" :key="i" :value="kelompok_laporan_foto.id">
                          {{ kelompok_laporan_foto.kelompok_laporan_foto }}
                        </option>
                      </select>
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                      ...
                      <input type="date"
                        class="form-control"
                        v-model="query.form_laporan_foto.tanggal_form"
              ...
              <button class="btn btn-primary"
                ...
                v-if="
                  $access('formOperasional.formFoto', 'create') && (
                    ...
                    $moment($moment(query.form_laporan_foto.tanggal_form)).isBetween(
              ...
              <div class="table-responsive mt-2">
                <table class="table table-hover" v-if="$access('formOperasional.formFoto', 'read')">
                  ...
                  <tbody>
                    <tr v-for="(form_laporan_foto, i) in data.form_laporan_foto">
                      <td>{{ i + 1 }}</td>
                      <td>{{ form_laporan_foto.tugas_karyawan == null ? '-' : form_laporan_foto.tugas_karyawan.karyawan.nip }}</td>
                      <td>{{ form_laporan_foto.tugas_karyawan == null ? '-' : form_laporan_foto.tugas_karyawan.karyawan.nama_karyawan }}</td>
                      <td>{{ form_laporan_foto.jam }}</td>
                      <td>
                        <a class="badge badge-warning"
                          @click="showUpdateModal(form_laporan_foto.id)"
                          href="#"
                          v-if="
                        ...
                        <a class="badge badge-danger"
                          @click="showDestroyModal(form_laporan_foto.id)"
                          href="#"
                          v-if="
        ...
        <div class="modal-content">
          <form @submit.prevent="create">
            <div class="modal-header">
              <h5 class="modal-title">Tambah Form Laporan Foto</h5>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label>Kelompok Laporan Foto</label>
                <select class="form-control" v-model="form.create.data.kelompok_laporan_foto_id">
                  <option value="null">-- Pilih Kelompok Laporan Foto --</option>
                  <option v-for="(kelompok_laporan_foto, i) in data.kelompok_laporan_foto" :value="kelompok_laporan_foto.id">
                    {{ kelompok_laporan_foto.kelompok_laporan_foto }}
                  </option>
                </select>
                <small class="text-danger" v-for="(msg, i) in form.create.errors.kelompok_laporan_foto_id">
                  {{ msg }}
                </small>
              </div>
              <div class="form-group">
                <label>Gambar</label>
                <input type="file" @input="handleCreateFile" class="form-control">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form @submit.prevent="update">
            <div class="modal-header">
              <h5 class="modal-title">Ubah Form Laporan Foto</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              ...
              <div class="form-group">
                <label>Kelompok Laporan Foto</label>
                <select class="form-control" v-model="form.update.data.kelompok_laporan_foto_id">
                  <option value="null">-- Pilih Kelompok Laporan Foto --</option>
                  <option v-for="(kelompok_laporan_foto, i) in data.kelompok_laporan_foto" :value="kelompok_laporan_foto.id">
                    {{ kelompok_laporan_foto.kelompok_laporan_foto }}
                  </option>
                </select>
                <small class="text-danger" v-for="(msg, i) in form.update.errors.kelompok_laporan_foto_id">
                  {{ msg }}
                </small>
              </div>
              <div class="form-group" v-if="$access('formOperasional.formFoto.update', 'takePhoto')">
                <label>Gambar</label>
                <input type="file" @input="handleUpdateFile" class="form-control">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <form @submit.prevent="destroy">
              <div class="modal-header">
                <h5 class="modal-title">Hapus Form Laporan Foto</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
...
export default {
    ...
    return {
      ...
      query: {
        form_laporan_foto: {
          ...
          kelompok_laporan_foto_id: this.$route.query.kelompok_laporan_foto_id || null
        }
      },
      interval: {
        form: {
  ...
  watch: {
    'query.form_laporan_foto.tanggal_form'(n, o) {
      if (this.$access('formOperasional.formFoto.read', 'timeFree')) {
        this.query.form_laporan_foto.tanggal_form = n
      } else {
        if (
          ...
          this.query.form_laporan_foto.tanggal_form = o
        }
      }
    }
  },
  methods: {
    ...
    prepare() {
      ...
      Promise.all([
        ...
        .then(res => {
          ...
          this.data.kelompok_laporan_foto = res[1].data.container

          if (this.data.cabang.length <= 0 || this.data.tipe_absensi <= 0) {
            this.$router.go(-1)
          }

          if (this.query.form_laporan_foto.cabang_id == null || ! this.$_.isUndefined(this.$_.findWhere(this.data.cabang, { id: this.query.form_laporan_foto.cabang_id }))) {
            this.query.form_laporan_foto.cabang_id = this.data.cabang[0].id || null
          }
          if (this.query.form_laporan_foto.kelompok_laporan_foto_id == null || ! this.$_.isUndefined(this.$_.findWhere(this.data.kelompok_laporan_foto, { id: this.query.form_laporan_foto.kelompok_laporan_foto_id }))) {
            this.query.form_laporan_foto.kelompok_laporan_foto_id = this.data.kelompok_laporan_foto[0].id || null
          }
    ...
    queryData(withSpinner = true) {
      ...
      this.fetchMainData()
        .then(res => {
          if ( ! this.$_.isEqual(this.$route.query, this.query.form_laporan_foto) && this.$route.name === 'formOperasional.formFoto') {
            this.$router.push({
              name: 'formOperasional.formFoto',
              query: this.query.form_laporan_foto
            })
          }
          this.data.form_laporan_foto = res.data.container
     ...
     */
    fetchMainData() {
      return this.$axios.get('/ajax/v1/form_operasional/form_laporan_foto/cabang_tipe_harian', { params: this.query.form_laporan_foto })
    },
    fetchCabang() {
    ...
    fetchKelompokFoto() {
      return this.$axios.get('/ajax/v1/master/kelompok_laporan_foto')
    },
    ...
    showCreateModal() {
      Promise.all([
        this.fetchTugasKaryawan(this.query.form_laporan_foto.cabang_id, this.query.form_laporan_foto.tanggal_penugasan),
        this.fetchKelompokFoto()
      ])
        .then(res => {
          ...
          this.form.create.data.tanggal_form = this.query.form_laporan_foto.tanggal_form
          let currentCabang = this.$_.findWhere(this.data.cabang, {id: parseInt(this.query.form_laporan_foto.cabang_id)})
    ...
    showUpdateModal(id) {
      ...
      this.$axios.get('/ajax/v1/form_operasional/form_laporan_foto/' + id)
        .then(res => {
          let currentCabang = this.$_.findWhere(this.data.cabang, {id: parseInt(this.query.form_laporan_foto.cabang_id)})
          this.form.update.data = {
            id: id,
            ...
            tanggal_form: this.query.form_laporan_foto.tanggal_form,
            jam: res.data.container.jam,
            tugas_karyawan_id: res.data.container.tugas_karyawan_id,
            kelompok_laporan_foto_id: res.data.container.kelompok_laporan_foto_id,
    ...
    handleCreateFile(e) {
      ...
      r.onload = () => this.form.create.data.gambar = r.result
      this.$emit('input', e.target.files[0])
    },
    handleUpdateFile(e) {
      let r = new FileReader()
      r.readAsDataURL(e.target.files[0])
      r.onload = () => this.form.update.data.gambar = r.result
      this.$emit('input', e.target.files[0])
    },
      ...
      if (this.$access('formOperasional.formFoto', 'read')) {
        if (this.$access('formOperasional.formFoto.read', 'timeFree')) {
          ...
          if (
            ...
            this.query.form_laporan_foto.tanggal_form = this.$moment().format('YYYY-MM-DD')
            this.queryData()
          }
        }
      }
    ...
    create() {
      ...
      this.$axios.post('/ajax/v1/form_operasional/form_laporan_foto', this.form.create.data)
        .then(res => {
    ...
    update() {
      ...
      this.$axios.put('/ajax/v1/form_operasional/form_laporan_foto', this.form.update.data)
        .then(res => {
          this.form.update.data = {
            id: null,
            kode_cabang: '',
    ...
    destroy() {
      ...
      this.$axios.delete('/ajax/v1/form_operasional/form_laporan_foto', { data: this.form.destroy.data })
        .then(res => {
