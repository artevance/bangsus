  ...
  <div class="row mt-5 justify-content-center">
    <transition name="fade" mode="out-in">
      <div class="col col-xl-12 stretch-card" v-if="!state.page.loading">
        <div class="card">
          <div class="card-body">
            <router-link :to="{ name: 'formOperasional.dailyOutgoingMutation' }">
              <i class="fas fa-backspace"></i>
              Kembali
            </router-link>
            <div class="card-title">Detail Mutasi Keluar</div>
            <form>
              <div class="row">
                <div class="col col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" v-model="form.detail.data.cabang_tujuan_id" disabled>
