      ...
      <div class="col col-xl-12 stretch-card" v-if="!state.page.loading">
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-title">Ubah Mutasi Keluar</div>
            <form>
              <div class="row">
...
export default {
  ...
  methods: {
      ...
      Promise.all([
        ...
        .then(res => {
          ...
          mainData.d.forEach((item, i) => {
            let request = this.$axios.get('/ajax/v1/form_operasional/outgoing_mutation/gambar/' + item.id, { responseType: 'blob' })
    ...
    fetchMainData() {
      return this.$axios.get('/ajax/v1/form_operasional/outgoing_mutation/' + this.$route.params.id)
    },
    fetchCabang() {
    ...
    update() {
      ...
      this.$axios.put('/ajax/v1/form_operasional/outgoing_mutation', this.form.update.data)
        .then(res => {
          this.form.update.data = {
            id: null,
            cabang_id: null,
