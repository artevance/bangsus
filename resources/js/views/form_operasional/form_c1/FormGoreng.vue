    ...
    <transition name="fade" mode="out-in">
      ...
      <div v-else>
          ...
          <div class="col-12">
            <div class="form-group">
              <div class="input-group">
                ...
                <select class="form-control" v-model="query.form_goreng.cabang_id" @change="queryData">
        ...
        <button class="btn btn-primary"
          ...
          v-if="
            $access('formOperasional.formC1.formGoreng', 'create') && (
              $access('formOperasional.formC1.formGoreng.create', 'timeFree') ||
              $moment($moment(query.form_goreng.tanggal_form)).isBetween(
                $moment(utils.date).subtract($access('formOperasional.formC1.formGoreng.create', 'dateMin')).format('YYYY-MM-DD'),
                $moment(utils.date).add($access('formOperasional.formC1.formGoreng.create', 'dateMax')).format('YYYY-MM-DD'),
                undefined,
                '[]'
              )
            )
        ...
        <div class="table-responsive mt-2">
          <table class="table table-hover" v-if="$access('formOperasional.formC1.formGoreng', 'read')">
            <thead>
              <th>#</th>
              <th>NIP</th>
              <th>Nama Karyawan</th>
            ...
            <tbody>
              <tr v-for="(form_goreng, i) in data.form_goreng">
                <td>{{ i + 1 }}</td>
                <td>{{ form_goreng.tugas_karyawan.karyawan.nip }}</td>
                <td>{{ form_goreng.tugas_karyawan.karyawan.nama_karyawan }}</td>
                <td>{{ form_goreng.jam }}</td>
                <td>{{ form_goreng.item_goreng.item_goreng }}</td>
                <td>{{ form_goreng.qty }}</td>
                <td>{{ form_goreng.satuan.satuan }}</td>
                <td>{{ form_goreng.supplier.supplier }}</td>
                <td>
                  <a class="badge badge-warning"
                    @click="showUpdateModal(form_goreng.id)"
                    href="#"
                    v-if="
                      $access('formOperasional.formC1.formGoreng', 'update') && (
                        $access('formOperasional.formC1.formGoreng.update', 'timeFree') ||
                        $moment($moment(query.form_goreng.tanggal_form)).isBetween(
                          $moment(utils.date).subtract($access('formOperasional.formC1.formGoreng.update', 'dateMin')).format('YYYY-MM-DD'),
                          $moment(utils.date).add($access('formOperasional.formC1.formGoreng.update', 'dateMax')).format('YYYY-MM-DD'),
                          undefined,
                          '[]'
                        )
                      )
                  ...
                  <a class="badge badge-danger"
                    @click="showDestroyModal(form_goreng.id)"
                    href="#"
                    v-if="
                      $access('formOperasional.formC1.formGoreng', 'destroy') && (
                        $access('formOperasional.formC1.formGoreng.destroy', 'timeFree') ||
                        $moment($moment(query.form_goreng.tanggal_form)).isBetween(
                          $moment(utils.date).subtract($access('formOperasional.formC1.formGoreng.destroy', 'dateMin')).format('YYYY-MM-DD'),
                          $moment(utils.date).add($access('formOperasional.formC1.formGoreng.destroy', 'dateMax')).format('YYYY-MM-DD'),
                          undefined,
                          '[]'
                        )
                      )
    ...
    <div class="modal fade"
      ...
      v-if="
        $access('formOperasional.formC1.formGoreng', 'create') && (
          $access('formOperasional.formC1.formGoreng.create', 'timeFree') ||
          $moment($moment(query.form_goreng.tanggal_form)).isBetween(
            $moment().subtract($access('formOperasional.formC1.formGoreng.create', 'dateMin')).format('YYYY-MM-DD'),
            $moment().add($access('formOperasional.formC1.formGoreng.create', 'dateMax')).format('YYYY-MM-DD'),
            undefined,
            '[]'
          )
        )
          ...
          <form @submit.prevent="create">
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-12 col-lg-6">
                  ...
                  <input
                    ...
                    :readonly="$access('formOperasional.formC1.formGoreng.create', 'automatedTime')"
                    >
              ...
              <div class="form-group row">
                ...
                <template v-if="$access('formOperasional.formC1.formGoreng.create', 'changeSatuan')">
                  <div class="col-12 col-lg-3">
                    <label>Qty</label>
    ...
    <div class="modal fade"
      ...
      v-if="
        $access('formOperasional.formC1.formGoreng', 'update') && (
          $access('formOperasional.formC1.formGoreng.update', 'timeFree') ||
          $moment($moment(query.form_goreng.tanggal_form)).isBetween(
            $moment().subtract($access('formOperasional.formC1.formGoreng.update', 'dateMin')).format('YYYY-MM-DD'),
            $moment().add($access('formOperasional.formC1.formGoreng.update', 'dateMax')).format('YYYY-MM-DD'),
            undefined,
            '[]'
          )
        )
          ...
          <form @submit.prevent="update">
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-12 col-lg-6">
                  ...
                  <input
                    ...
                    :readonly="$access('formOperasional.formC1.formGoreng.update', 'readonlyTime')"
                    >
              ...
              <div class="form-group row">
                ...
                <template v-if="$access('formOperasional.formC1.formGoreng.update', 'changeSatuan')">
                  <div class="col-12 col-lg-3">
                    <label>Qty</label>
              ...
              <div class="form-group" v-if="$access('formOperasional.formC1.formGoreng.update', 'takePhoto')">
                <label>Gambar</label>
    ...
    <div class="modal fade"
      ...
      v-if="
        $access('formOperasional.formC1.formGoreng', 'destroy') && (
          $access('formOperasional.formC1.formGoreng.destroy', 'timeFree') ||
          $moment($moment(query.form_goreng.tanggal_form)).isBetween(
            $moment().subtract($access('formOperasional.formC1.formGoreng.destroy', 'dateMin')).format('YYYY-MM-DD'),
            $moment().add($access('formOperasional.formC1.formGoreng.destroy', 'dateMax')).format('YYYY-MM-DD'),
            undefined,
            '[]'
          )
        )
...
export default {
    ...
    return {
      ...
      query: {
        form_goreng: {
          ...
          tanggal_form: this.$access('formOperasional.formC1.formGoreng.read', 'timeFree')
            ...
            : (
              this.$moment(this.$moment(this.$route.query.tanggal_form).format('YYYY-MM-DD')).isBetween(
                this.$moment().subtract(this.$access('formOperasional.formC1.formGoreng.read', 'dateMin')).format('YYYY-MM-DD'),
                this.$moment().add(this.$access('formOperasional.formC1.formGoreng.read', 'dateMax')).format('YYYY-MM-DD'),
                undefined,
                '[]'
              )
                ? this.$moment(this.$route.query.tanggal_form).format('YYYY-MM-DD')
  ...
  mounted() {
    ...
    if (this.$access('formOperasional.formC1.formGoreng', 'create') && this.$access('formOperasional.formC1.formGoreng.create', 'automatedTime')) {
  ...
  watch: {
    'query.form_goreng.tanggal_form'(n, o) {
      if (this.$access('formOperasional.formC1.formGoreng.read', 'timeFree')) {
        this.query.form_goreng.tanggal_form = n
      } else {
        if (
          ...
          this.query.form_goreng.tanggal_form = o
        }
      }
    }
  },
  methods: {
    ...
    prepare() {
      ...
      Promise.all([
        ...
        .then(res => {
          ...
          if (this.query.form_goreng.cabang_id == null || ! this.$_.isUndefined(this.$_.findWhere(this.data.cabang, { id: this.query.form_goreng.cabang_id }))) {
            this.query.form_goreng.cabang_id = this.data.cabang[0].id || null
          }
    ...
    queryData(withSpinner = true) {
      ...
      this.fetchMainData()
        .then(res => {
          if ( ! this.$_.isEqual(this.$route.query, this.query.form_goreng) && this.$route.name === 'formOperasional.formC1.formGoreng') {
            this.$router.push({
              name: 'formOperasional.formC1.formGoreng',
              query: this.query.form_goreng
            })
          }
          this.data.form_goreng = res.data.container
     ...
     */
    fetchMainData() {
      return this.$axios.get('/ajax/v1/form_operasional/form_c1/form_goreng/cabang_harian', { params: this.query.form_goreng })
    },
    fetchCabang() {
    ...
    showCreateModal() {
      Promise.all([
        this.fetchTugasKaryawan(this.query.form_goreng.cabang_id, this.query.form_goreng.tanggal_penugasan),
        this.fetchSupplier(),
        this.fetchSatuan(),
        ...
        .then(res => {
          ...
          this.form.create.data.tanggal_form = this.query.form_goreng.tanggal_form
          let currentCabang = this.$_.findWhere(this.data.cabang, {id: parseInt(this.query.form_goreng.cabang_id)})
    ...
    showUpdateModal(id) {
      ...
      this.$axios.get('/ajax/v1/form_operasional/form_c1/form_goreng/' + id)
        .then(res => {
          let currentCabang = this.$_.findWhere(this.data.cabang, {id: parseInt(this.query.form_goreng.cabang_id)})
          this.form.update.data = {
            id: id,
            ...
            tanggal_form: this.query.form_goreng.tanggal_form,
    ...
    dateChangeHandler() {
      ...
      if (this.$access('formOperasional.formC1.formGoreng', 'read')) {
        if (this.$access('formOperasional.formC1.formGoreng.read', 'timeFree')) {
          ...
          if (
            ...
            this.query.form_goreng.tanggal_form = this.$moment().format('YYYY-MM-DD')
            this.queryData()
          }
        }
      }
      // Handle date change on create action
      if (this.$access('formOperasional.formC1.formGoreng', 'create')) {
        if (this.$access('formOperasional.formC1.formGoreng.create', 'timeFree')) {

        } else {
          if (
            this.$moment(this.utils.date).isBetween(
              this.$moment().subtract(this.$access('formOperasional.formC1.formGoreng.create', 'dateMin')).format('YYYY-MM-DD'),
              this.$moment().add(this.$access('formOperasional.formC1.formGoreng.create', 'dateMax')).format('YYYY-MM-DD'),
              undefined,
              '[]'
            )
          ) {
      ...
      if (this.$access('formOperasional.formC1.formGoreng', 'update')) {
        if (this.$access('formOperasional.formC1.formGoreng.update', 'timeFree')) {

        } else {
          if (
            this.$moment(this.utils.date).isBetween(
              this.$moment().subtract(this.$access('formOperasional.formC1.formGoreng.update', 'dateMin')).format('YYYY-MM-DD'),
              this.$moment().add(this.$access('formOperasional.formC1.formGoreng.update', 'dateMax')).format('YYYY-MM-DD'),
              undefined,
              '[]'
            )
          ) {
      ...
      if (this.$access('formOperasional.formC1.formGoreng', 'destroy')) {
        if (this.$access('formOperasional.formC1.formGoreng.destroy', 'timeFree')) {

        } else {
          if (
            this.$moment(this.utils.date).isBetween(
              this.$moment().subtract(this.$access('formOperasional.formC1.formGoreng.destroy', 'dateMin')).format('YYYY-MM-DD'),
              this.$moment().add(this.$access('formOperasional.formC1.formGoreng.destroy', 'dateMax')).format('YYYY-MM-DD'),
              undefined,
              '[]'
            )
          ) {
    ...
    create() {
      ...
      this.$axios.post('/ajax/v1/form_operasional/form_c1/form_goreng', this.form.create.data)
        .then(res => {
    ...
    update() {
      ...
      this.$axios.put('/ajax/v1/form_operasional/form_c1/form_goreng', this.form.update.data)
        .then(res => {
          this.form.update.data = {
            id: null,
            kode_cabang: '',
    ...
    destroy() {
      ...
      this.$axios.delete('/ajax/v1/form_operasional/form_c1/form_goreng', { data: this.form.destroy.data })
        .then(res => {
