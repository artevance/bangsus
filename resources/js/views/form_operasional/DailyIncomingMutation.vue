                    ...
                    <tbody>
                      <tr v-for="(incoming_mutation, i) in data.incoming_mutation">
                        ...
                        <td>
                          ...
                          <a class="badge badge-dark" href="#" @click.prevent="exportData(incoming_mutation.id)" v-if="incoming_mutation.accepted == 1">
                            Ekspor
                          </a>
                        </td>
                      </tr>
...
export default {
  ...
  methods: {
    ...
    exportData(id) {
      this.$axios.get('/ajax/v1/form_operasional/incoming_mutation/report/' + id, { responseType: 'blob' })
        .then(res => {
