  ...
  <div class="row mt-5 justify-content-center">
    <transition name="fade" mode="out-in">
      <div class="col col-xl-12 stretch-card" v-if="!state.page.loading">
        <div class="card">
          <div class="card-body">
            <router-link :to="{ name: 'formOperasional.rencanaKebutuhanBahan' }">
              <i class="fas fa-backspace"></i>
              Kembali
            </router-link>
            <div class="card-title">Review Rencana Kebutuhan Bahan</div>
            <form>
              <div class="row">
...
export default {
  ...
  methods: {
    ...
    fetchMainData() {
      return this.$axios.get('/ajax/v1/form_operasional/rencana_kebutuhan_bahan/' + this.$route.params.id)
    },
    fetchCabang() {
    ...
    update() {
      ...
      this.$axios.put('/ajax/v1/form_operasional/rencana_kebutuhan_bahan/accept', this.form.update.data)
        .then(res => {
          this.form.update.data = {
            id: null,
            cabang_id: null,
    ...
    closeModal() {
      ...
      this.$router.push({ name: 'formOperasional.rencanaKebutuhanBahan' })
    }
  }
}
</script>