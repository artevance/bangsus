...
<button class="btn btn-primary mt-5" data-toggle="modal" data-target=".modal[data-entity='formThawingAyam'][data-method='tambah']">Tambah Form Thawing Ayam</button>
<div class="table-responsive mt-2">
  <table class="table table-hover" data-entity="formThawingAyam">
    <thead>
      <th>#</th>
      <th>NIP</th>
      <th>Nama Karyawan</th>
...
<!-- Modal -->
<div class="modal fade" data-entity="formThawingAyam" data-method="tambah" data-backdrop="static" data-keyboard="false" tabindex="-1">
...
<div class="modal fade" data-entity="formThawingAyam" data-method="ubah" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form>
        <div class="modal-header">
...
<div class="modal fade" data-entity="formThawingAyam" data-method="hapus" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form>
        <div class="modal-header">
...
<script src="{{ url('/assets/js/adapter/leader/FormThawingAyam.js') }}"></script>
<script type="text/javascript">
  let formThawingAyam = FormThawingAyam();

  formThawingAyam.setQuery(@json($serializedQuery));
  formThawingAyam.responsiveContract();
</script>