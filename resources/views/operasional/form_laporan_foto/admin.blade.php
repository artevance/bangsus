...
<button class="btn btn-primary mt-5" data-toggle="modal" data-target=".modal[data-entity='formLaporanFoto'][data-method='tambah']">Tambah Form Laporan Foto</button>
...
<script src="{{ url('/assets/js/adapter/admin/FormLaporanFoto.js') }}"></script>
