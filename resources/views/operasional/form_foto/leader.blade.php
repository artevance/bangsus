...
<button class="btn btn-primary mt-5" data-toggle="modal" data-target=".modal[data-entity='formFoto'][data-method='tambah']">Tambah Form Foto</button>
<div class="table-responsive mt-2">
  <table class="table table-hover" data-entity="formFoto">
    <thead>
      <th>#</th>
      <th>NIP</th>
      <th>Nama Karyawan</th>
...
<!-- Modal -->
<div class="modal fade" data-entity="formFoto" data-method="tambah" data-backdrop="static" data-keyboard="false" tabindex="-1">
      ...
      <form>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="kelompok_foto_id"></select>
...
<div class="modal fade" data-entity="formFoto" data-method="ubah" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form>
        <div class="modal-header">
...
<div class="modal fade" data-entity="formFoto" data-method="hapus" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form>
        <div class="modal-header">
...
<script src="{{ url('/assets/js/adapter/leader/FormFoto.js') }}"></script>
<script type="text/javascript">
  let formFoto = FormFoto();

  formFoto.setQuery(@json($serializedQuery));
  formFoto.responsiveContract();
</script>