    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive mt-2">
          <table class="table table-hover" data-entity="pengajuanJadwalAbsensi">
            <thead>
              <th>#</th>
              <th>NIP</th>
              <th>Nama Karyawan</th>
...
<!-- Modal -->
<div class="modal fade" data-entity="pengajuanJadwalAbsensi" data-method="tambah" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form>
        <div class="modal-header">
          <h5 class="modal-title">Pengajuan Jadwal Baru</h5>
...
<div class="modal fade" data-entity="pengajuanJadwalAbsensi" data-method="ubah" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form>
        <div class="modal-header">
          <h5 class="modal-title">Pengajuan Perubahan Jadwal</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" data-entity="pengajuanJadwalAbsensi" data-method="hapus" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form>
        <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
        <div class="modal-header">
          <h5 class="modal-title">Pengajuan Penghapusan Jadwal</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<div class="modal fade" data-entity="pengajuanJadwalAbsensi" data-method="terima" data-backdrop="static" data-keyboard="false" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form>
        <div class="modal-header">
          <h5 class="modal-title">Terima Pengajuan Jadwal</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Jam Jadwal</label>
            <input type="time" class="form-control" name="jam_jadwal" readonly>
            <small class="form-text text-danger" data-role="feedback" data-field="jam_jadwal"></small>
          </div>
        </div>
        <div class="modal-footer">
...
<script src="{{ url('/assets/js/adapter/admin/PengajuanJadwalAbsensi.js') }}"></script>
<script type="text/javascript">
  let pengajuanJadwalAbsensi = PengajuanJadwalAbsensi();

  pengajuanJadwalAbsensi.setQuery(@json($serializedQuery));
  pengajuanJadwalAbsensi.responsiveContract();
</script>